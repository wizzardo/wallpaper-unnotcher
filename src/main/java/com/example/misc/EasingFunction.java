...
public interface EasingFunction {
    ...
    EasingFunction EASE_IN_ELASTIC = x -> x == 0 ? 0 : (float) (x == 1 ? 1 : -Math.pow(2, 10 * x - 10) * Math.sin((x * 10 - 10.75f) * c4));
    EasingFunction EASE_OUT_ELASTIC = x -> x == 0 ? 0 : (float) (x == 1 ? 1 : Math.pow(2, -10 * x) * Math.sin((x * 10 - 0.75f) * c4) + 1);
    EasingFunction EASE_IN_OUT_ELASTIC = x -> x == 0 ? 0 : (float) (x == 1 ? -(Math.pow(2, 20 * x - 10) * Math.sin((20 * x - 11.125f) * c5)) / 2 :
